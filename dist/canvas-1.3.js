var DrawingCanvas = /** @class */ (function () {
    ...
    DrawingCanvas.prototype.addDownloadButton = function (side, img) {
        ...
        newButton.onclick = function () {
            var downloadFile = _this.canvas.toDataURL("image/png").replace("image/png", "image/octet-stream");
        ...
        if (img != null) {
            ...
            img.split(' ').forEach(function (cls) { return buttonImg_2.classList.add(cls); });
            // let buttonImg = document.createElement('img');
            // buttonImg.src = img;
